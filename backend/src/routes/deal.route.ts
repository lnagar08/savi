...
import { createDeal, parseDeal, getDeals, getDealById, updateInputs, removeDeal } from "../controllers/deal.controller.js";
...
dealRouter.delete("/:id", authMiddleware, removeDeal);
